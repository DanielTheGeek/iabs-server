...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <style type="text/css">
			...
			/* ========== Color Style ========== */
			#colored h3 {color:#ed8207 !important;}
			...
			*/
			h2{
				/*@editable*/ color:#ed8207 !important;
				display: inline-block;
				font-family: Arial, Helvetica, sans-serif;
	...
	<body marginheight="0" marginwidth="0" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" offset="0" style="padding:0px;">
    	<center>
            ...
            <table align="center" width="100%">
            	...
            	<?php $this->load->view('includes/mails/inc/header'); ?>
                            ...
                            <tr class="titleline">
                            	<td align="left" class="bodyContent10px" valign="middle" width="100%" height="21" style=" padding:10px; padding-top:30px; padding-bottom:0px;">
                                	<table border="0" cellpadding="0" cellspacing="0" width="100%" height="1">
                                    	<tr>
                                        	<td valign="top" mc:edit="new_products_2_columns" style="width:100%; padding-bottom:3px; color: #383838; font-size: 20px; font-weight:normal; font-family:Georgia, 'Times New Roman', Times, serif; border-bottom:1px solid #ECECEA; text-align:center;">
	                                            
	                                              <singleline label="{subject}">{subject}</singleline> 
                            ...
                            <tr class="content_msg">
                            	<td align="center" valign="top" style="padding-bottom:20px;">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                        <tr mc:repeatable>
                                            <td valign="top" class="bodyContent" style="padding-top:30px; padding-left:10px; padding-right:10px; padding-bottom:20px; text-align:center;" mc:edit="slogan_one"><singleline label="Slogan One">{content}</singleline></td>
                                        </tr>
                                    </table>
                                    ...
                                    <table id="button" align="center" width="100" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;">
                                    	<tbody>
                                        	<tr>
                                            	<td valign="middle" bgcolor="#ed8207" align="center" height="25" style="border-collapse: collapse;">
                                                	<a style="color: #ffffff !important;text-decoration: none;outline: none; display: block; font-size:12px;" href="{button_link}">
                                                    <font color="#FFFFFF" face="Arial, Helvetica, sans-serif"> 
                                                    <singleline label='{button_title}'>{button_title}</singleline>
                                                    </font>
                                                    </a>
                                                </td>
                                             </tr>                    
            ...
            <?php $this->load->view('includes/mails/inc/footer'); ?>
           </table>
        </center>
    </body>
</html>