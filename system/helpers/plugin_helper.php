...
if ( ! function_exists('set_plugin_message')) {
    /**
     * Shortcut to Plugins_lib::set_plugin_message()
     *
     * Sets plugin frontend messages 
     * 
     * @param array $array Array containing message details
     * @since 0.1.0
     * @return mixed
    */
    function set_plugin_message( $array )
    {
        return Plugins_lib::$instance->set_plugin_message( $array );
    }
}